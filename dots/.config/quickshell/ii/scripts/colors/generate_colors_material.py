...
parser.add_argument('--dark-style', choices=['standard', 'midnight'], default='standard', help='style for dark mode')
...
if darkmode and args.dark_style == 'midnight':
    material_colors = {key: midnight_color(value) for key, value in material_colors.items()}
