...
Singleton {
    ...
    ColorQuantizer {
        id: wallColorQuant
        property string wallpaperPath: Config.effectiveWallpaperPathSetting
        ...
        source: Qt.resolvedUrl(wallpaperIsVideo ? Config.effectiveThumbnailPathSetting : Config.effectiveWallpaperPathSetting)
        depth: 0 // 2^0 = 1 color
        rescaleSize: 10
    }
    ...
    colors: QtObject {
        ...
        // Layer 0
        property color colLayer0Base: ColorUtils.mix(m3colors.m3background, m3colors.m3primary, !root.pureBlack && Config.options.appearance.extraBackgroundTint ? 0.99 : 1)
