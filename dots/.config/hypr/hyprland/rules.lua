...
hl.layer_rule({ match = { namespace = "quickshell:bar" }, order = 0})
hl.layer_rule({ match = { namespace = "quickshell:verticalBar" }, order = 0})
hl.layer_rule({ match = { namespace = "quickshell:osk" }, order = -1})
hl.layer_rule({ match = { namespace = "quickshell:sidebarLeft" }, order = -2})
hl.layer_rule({ match = { namespace = "quickshell:dock" }, order = -3})
hl.layer_rule({ match = { namespace = "quickshell:session" }, order = -4})
hl.layer_rule({ match = { namespace = "quickshell:regionSelector" }, order = -5})
hl.layer_rule({ match = { namespace = "quickshell:screenCorners" }, order = -6})
-- Quickshell: waffles
